...
const customTheme = {
  button: {
    ...
    color: {
      ...
      info: "border border-transparent bg-orange-500 text-white focus:ring-4 focus:ring-orange-300 enabled:hover:bg-orange-800 dark:bg-orange-600 dark:focus:ring-orange-800 dark:enabled:hover:bg-orange-700",
      light:
