...
function Navbar() {
  ...
  return (
    <>
      <div className="flex fixed top-0 left-0 right-0 z-[1000] justify-between items-center px-8 py-6 bg-slate-50 text-slate-950 border-b border-b-slate-300">
